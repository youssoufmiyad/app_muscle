    ...
    return (
        ...
        justifyContent="center" p="20px">
            <form>
                ...
                <Input type='password' placeholder='retype your password' id="confirmPassword" name="confirmPassword"
                    onChange={(e) => {
                ...
                <Button className="search-btn"
                    ...
                    onClick={(e) => {
                        if(passwordCheck === password){
                            ...
                            console.log("2 different passwords")
                        }
            ...
            <Link marginTop="" underline="none" color="ButtonHighlight" style={{ textDecoration: 'none', color: '#000000', fontSize: "12px", fontWeight: "700" }}>
